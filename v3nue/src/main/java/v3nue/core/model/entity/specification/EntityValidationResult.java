 ...
 *
 */
public class EntityValidationResult<T> {
	...
	public EntityValidationResult(T entity, Map<String, String> messages, int status) {
		super();
		this.entity = entity;
	...
	public static <T extends AbstractEntity> EntityValidationResult<T> success(T entity,
			Map<String, String> messages) {

		return new EntityValidationResult<T>(entity, messages, 200);
	}

	public static <T extends AbstractEntity> EntityValidationResult<T> error(T entity,
			Map<String, String> messages, int status) {

		return new EntityValidationResult<T>(entity, messages, status);
	}
