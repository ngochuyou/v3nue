...
public class SeatingSpecification extends CompositeSpecification<Seating> {
	...
	@Override
	public ServiceResult<Seating> isSatisfiedBy(Seating entity) {
		...
		if (capacity < 0 || capacity > 16777215) {
			...
			return new ServiceResult<Seating>(entity, messages, BAD);
		}

		return new ServiceResult<Seating>(entity, messages, OK);
	}
