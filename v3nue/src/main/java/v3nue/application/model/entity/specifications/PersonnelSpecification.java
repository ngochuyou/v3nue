...
public class PersonnelSpecification extends CompositeSpecificationWithDAO<Personnel> {
	...
	@Override
	public EntityValidationResult<Personnel> isSatisfiedBy(Personnel entity) {
		...
		if (specialization == null || dao.findById(specialization.getId(), Specialization.class) == null) {
			...
			return new EntityValidationResult<Personnel>(entity, messages, BAD);
		}

		return new EntityValidationResult<Personnel>(entity, messages, OK);
	}
